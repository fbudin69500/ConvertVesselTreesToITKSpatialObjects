...
VESSCOL* VESSCOLUTILS::CompressVC(VESSCOL* inputvc)
   {
...
//---------------------------------------------
VESSCOL* VESSCOLUTILS::ProcessConnectionPoints(VESSCOL* v)
   {
   int numchanges = 0;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&77
      //PROTECTED
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
void VESSCOLUTILS::ConcatenateVessels(int par, int child, VESSCOL* tempvc)
   {
   VESS* vessptr1;
   VESS* vessptr2;
   VESS tempvess;
