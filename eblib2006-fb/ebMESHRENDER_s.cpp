#include "ebMESHRENDER_s.h"

namespace eb
{

MESHRENDER_s::MESHRENDER_s()
   {
   winx = winy = 0;
   currentpos = 0;
   angle = 0;
...
//---------------------------------
MESHRENDER_s::MESHRENDER_s(int wx, int wy, double a, OMAT* cp)
   {
   SetCameraIntrinsics(wx, wy, a);
   SetCurrentPos(cp);
   }
//------------------------------------------------------
void MESHRENDER_s::SetCameraIntrinsics(int wx, int wy, double a)
   {
   winx = wx;
   winy = wy;
   angle = a;
...
//---------------------------------------------
void MESHRENDER_s::Render(MESHCOL_s* mc, ZBUFF* circlezbuff, unsigned char* colorbuff, int x, int y, int _idoffset)
   {
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
int MESHRENDER_s::Round(float a)
   {
   if (a >= 0) return (int)(a + 0.5);
   return (int)(a - 0.5);
   }
//--------------------------------
double MESHRENDER_s::Dot(float* a, float* b)
   {
   return a[0] * b[0] + a[1] * b[1] + a[2] * b[2];
   }
//----------------------------------
void MESHRENDER_s::Normalize(float* a)
   {
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
      //FLAT SHADING
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
int MESHRENDER_s::DrawPixelsWithFacetNormals
(MESHCOL_s* vc, ZBUFF* circlezbuff, unsigned char* colorbuff, int x, int y)
   {
   int i, j, k, dobreak;
   float* fptr;
   float* col;
...
void MESHRENDER_s::GetColorForFacet(float* ambient, float* diffuse, int* icol, float costheta)
   {
...
void MESHRENDER_s::DrawFlatFacet(int* iptsx, int* iptsy, int* icol, ZBUFF* circlebuff, unsigned char* colorbuff, int xdim, int ydim, float zpos, int vessid, int ptid)
   {
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
      //GOURAUD SHADING
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
int MESHRENDER_s::DrawPixelsWithVertexNormals
(MESHCOL_s* mc, ZBUFF* circlezbuff, unsigned char* colorbuff, int x, int y)
   ...
   //---------------------------------------------------------------
         //Triangle shading
void MESHRENDER_s::DrawFacetGouraud(float* ambient, float* diffuse,\
...
//---------------------------------------------------
void MESHRENDER_s:: GetColorForVertex(float* ambient, float* diffuse, FVEC* srfn, FVEC* vv, FVEC* col)
   {
