...
#ifndef _ebMESHRENDER_h_
#define _ebMESHRENDER_h_
...
class MESHRENDER
   ...
   public:
       MESHRENDER();
      MESHRENDER(int winwidth, int winheight, double fov, OMAT* cp);
      ~MESHRENDER()      {}
     ...
     void Render(MESHCOL* mc, ZBUFF* circlezbuff, unsigned char* colorbuff, int x, int y, int _idoffset = 0);
