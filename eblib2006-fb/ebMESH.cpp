...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
      //LOADS
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
int MESH::CreateVessel(VESS* vess, int* d, float* s)
   {
...
int MESH::CreateOvoid(float* skel, float* scale)
   {
   Releasemem();
   numskelpoints = 1;
   preferquads = 1;
...
//----------------------------------------------------------
int MESH::CreateVessel(float* pts, int num, int* d, float* s)
   {
   Releasemem();
...
int MESH::CreateSurface(SURFACE* surf, unsigned char* maskfile, float* s, int myid) 
   {
  ...
  vertexsrfn = new FVEC[numvertices];
  if (!vertexsrfn) {std::cerr<<"Out of mem in MESH\n"; Releasemem(); return 0;}
...
FVEC* MESH::GetFirstTriangle(FVEC* facetnormal)
   {
...
FVEC* MESH::GetFirstTriangle(FVEC* facetnormal, FVEC* sn1, FVEC* sn2, FVEC* sn3)
   {
   if(!numtrianglefacets) return 0;
   onfacet = 0;
   int index = 3 * onfacet;
...
//-----------------------------------------------------------------
FVEC* MESH::GetNextTriangle(FVEC* facetnormal)
   {
   ++onfacet;
...
//----------------------------------------------------------
FVEC* MESH::GetNextTriangle(FVEC* facetnormal, FVEC* sn1, FVEC* sn2, FVEC* sn3)
   {
   ++onfacet;
   if(onfacet >= numtrianglefacets) 
      return 0;
...
//--------------------------------------------------------
FVEC* MESH::GetFirstQuad(FVEC* facetnormal)
   {
...
//-----------------------------------------------
FVEC* MESH::GetFirstQuad(FVEC* facetnormal, FVEC* sn1, FVEC* sn2, FVEC* sn3, FVEC* sn4)
   {
   onfacet = numtrianglefacets;
   if (onfacet >= numfacets)
      return 0;
...
//----------------------------------------
FVEC* MESH::GetNextQuad(FVEC* facetnormal)
   {
   ++onfacet;
...
//------------------------------------------
FVEC* MESH::GetNextQuad(FVEC* facetnormal, FVEC* sn1, FVEC* sn2, FVEC* sn3, FVEC* sn4)
   {
   ++onfacet;
   if (onfacet >= numfacets)
      return 0;
...
int MESH::GetSkeletonPointFromFacetNumber(int id)
   {
 ...
 //&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
      //LOADS AND SAVES
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
int MESH::Save(std::ofstream* ofile)
   {
   int i;
   float* fptr;
...
//------------------------------------------------------
int MESH::Load(std::ifstream* ifile)
   {
   ...
   while (ifile)
      ...
      if(!strcmp(commandstring, "END HEADER:"))
         break;
      if (!strcmp(commandstring, "END MESH"))
         break;
   ...
   while (ifile)
      {
      if (!strcmp(commandstring, "END MESH")) break;
...
int MESH::GetMinMax(float* mins, float* max)
   {
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&7
      //PROTECTED: OVOID MESH
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
int MESH::CreateOvoidQuadMesh(float* pts, float* scale)
   {
...
int MESH::CreateOvoidVertexNormals()
   {
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
      //PROTECTED: CREATE VESSEL MESH
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&

//------------------------------------------
int MESH::CreateVesselTriangleMesh(float* points)
   {
  int i, j, onvertexindex;
   float dirvec[3];
   OMAT mat;
...
//----------------------------------------
int MESH::CreateVesselQuadMesh(float* points)
   {
  int i, j, onvertexindex;
   float dirvec[3];
   OMAT mat;
...
//-------------------------------------------
int MESH::CreateVesselFacetSurfaceNormals()
   {
   float*fptr;
   double* dptr;
   GEOM geo;
...
//-----------------------------------
int MESH::CreateVesselVertexNormals()
   {
...
void MESH::VesselVertexNormalsTriangles()
   {
...
//--------------------------------------
void MESH::VesselVertexNormalsQuads()
   {
   int i, j, k, nfaces, onvertexsrfn;
   nfaces = (nstrips + 1);
   int* facelist = new int[nfaces];               //list of facets in one row,
...
void MESH::CreateCircleModel(FVEC* v)
   {
    int i;
   MATH math;
...
void MESH::ScaleModelCirclePoints(FVEC* v, float rad)
   {
   float* fptr;
...
//-----------------------------------------
void MESH::TranslateModelCirclePoints(FVEC* v, float* pt)
   {
   float* fptr;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
int MESH::CreateSurfaceQuadMesh(SURFACE* surf, unsigned char* maskfile, int myid)
   {
...
//-----------------------------------------------
int MESH::CompositeToVox(int val, int* x, int* y, int* z)
   {
...
//-------------------------------------------------
int MESH::DoLeftFace(int vox, unsigned char* tempbuff,\
...
//------------------------------------------------
int MESH::DoRightFace(int vox, unsigned char* tempbuff,\
LIST<int>* tempvertices, LIST<int>* tempvertexlist, LIST<int>* tempfsnlist, int myid)
   {
   int x, y, z, count;
   int ul, ll, lr, ur;
...
//------------------------------------------------
int MESH::DoFrontFace(int vox, unsigned char* tempbuff,\
LIST<int>* tempvertices, LIST<int>* tempvertexlist, LIST<int>* tempfsnlist, int myid)
   {
   int x, y, z, count;
   int ul, ll, lr, ur;
...
//-------------------------------------------------------
//------------------------------------------------
int MESH::DoBackFace(int vox, unsigned char* tempbuff,\
LIST<int>* tempvertices, LIST<int>* tempvertexlist, LIST<int>* tempfsnlist, int myid)
   {
   int x, y, z, count;
   int ul, ll, lr, ur;
...
//-------------------------------------------
//------------------------------------------------
int MESH::DoTopFace(int vox, unsigned char* tempbuff,\
LIST<int>* tempvertices, LIST<int>* tempvertexlist, LIST<int>* tempfsnlist, int myid)
   {
   int x, y, z, count;
   int ul, ll, lr, ur;
...
//------------------------------------------------
int MESH::DoBottomFace(int vox, unsigned char* tempbuff,\
LIST<int>* tempvertices, LIST<int>* tempvertexlist, LIST<int>* tempfsnlist, int myid)
   {
   int x, y, z, count;
   int ul, ll, lr, ur;
...
//------------------------------------------
void MESH::CreateSurfaceVertexNormals()
   {
   FVEC svec;
   FVEC* fptr;
   int i, index, val;
