...
class OBJECTIO
   ...
   public:
      OBJECTIO();
      OBJECTIO(const OBJECTIO&);
      virtual ~OBJECTIO();
      virtual OBJECTIO& operator = (const OBJECTIO& a);
      OBJECTIO& Copy(const OBJECTIO& a);
   ...
   int IsVein();
    void Anat(char* a);
    char* Anat()                        {return anat;}
   void TreeType(char* a);
   char* TreeType()               {return treetype;}
    void Type(char* a);                 
    char* Type()                        {return type;}
    void Name(char* a);
    char* Name()                        {return name;}                     
   char* DimDesc(int a);
   int DimDesc(int a, char* s);
   ...
   protected:
      ...
      virtual int LoadHeader(std::ifstream* ifile);
      virtual int LoadPoints(std::ifstream* ifile);
