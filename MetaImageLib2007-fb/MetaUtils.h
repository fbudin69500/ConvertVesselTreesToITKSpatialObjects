...
extern void *   MET_Alloc(MET_Type _pType, int _nDims, const int *_dimSize);
      ...
      //added 2008 to make old Stephen code work
#define MET_D()             std::cout << __FILE__ << " - " \
                                 << "Line " << __LINE__ << std::endl;

#define MET_DEBUG(a)        std::cout << __FILE__ << " - " \
                                 << "Line " << __LINE__ << ": " \
                                 << a << std::endl;

#define MET_DEBUG1(a,b)     std::cout << __FILE__ << " - " \
                                 << "Line " << __LINE__ << ": " \
                                 << a << " = " << b << std::endl

#define MET_DEBUG2(a,b,c,d) std::cout << __FILE__ << " - " \
                                 << "Line " << __LINE__ << ": " \
                                 << a << " = " << b << "; " \
                                 << c << " = " << d << std::endl
