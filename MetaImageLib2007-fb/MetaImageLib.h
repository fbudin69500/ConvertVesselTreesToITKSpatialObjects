...
class Image
   ...
   protected:
      ...
      void           InitImage(int _iNDims, const int * _iDimSize, MET_Type _eType, const float *_eSize=NULL, int _eNBits=0, bool _eByteOrderMSB=MET_SYSTEM_BYTE_ORDER_MSB, void *_eData=NULL);
      bool           ReadElements(void * lEData, int lQuantity, FILE *lfp);
   ...
   public:
      ...
      ////
      Image();
      Image(const char *_fname, bool _read_and_close=true);   // Read the file and possibly keep open - if kept open, pixel data not read
      Image(Image *_im);                                  // Duplicate structure but not data of another metaImage
      Image(int _iNDims, const int * _iDimSize, MET_Type _eType, const float *_eSize=NULL, int _eNBits=0, bool _eByteOrderMSB=MET_SYSTEM_BYTE_ORDER_MSB, void *_eData=NULL);
      Image(int _x, int _y, MET_Type _eType, const float *_eSize=NULL, int _eNBits=0, bool _eByteOrderMSB=MET_SYSTEM_BYTE_ORDER_MSB, void *_eData=NULL);
      Image(int _x, int _y, int _z, MET_Type _eType, const float *_eSize=NULL, int _eNBits=0, bool _eByteOrderMSB=MET_SYSTEM_BYTE_ORDER_MSB, void *_eData=NULL);
      ...
      //    OpenMetaFile(...)
      //       Reusable open file
      bool           OpenFile(const char *_fname, bool _read_and_close=true);       
